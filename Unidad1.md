...
Esta sección almacena las prácticas y actividades experimentales correspondientes al análisis descriptivo, cálculo de momentos y distribuciones de probabilidad notables aplicadas al proyecto.
...
Al finalizar estas prácticas, se estructuró la base matemática y descriptiva del conjunto de datos, asegurando la limpieza previa indispensable para dar el salto metodológico hacia los tests de inferencia de la Unidad 2.
